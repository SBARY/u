...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " روسيا"
SudosS = {5132023761,5526773564}
Sudos = {sudoid,5132023761,5526773564}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
type = 'inline',
data = {
{{text = '𝙍ᥙ᥉᥉Ꭵᥲ 𝘵𝘦𝘢𝘮 † . ',url="t.me/lFdll"}},
}
}
...
{{text = '- تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "روسيا"),data="delnamebot"}},
...
name = string.gsub(name,"هادئ","روسياي")
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "روسيا"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "روسيا"),"اني لقميل "..(redis:get(bot_id..":namebot") or "روسيا"),(redis:get(bot_id..":namebot") or "روسيا").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == "اكلك" or text == (redis:get(bot_id..":namebot") or "روسيا") then
...
local UserId_Info = bot.searchPublicChat("lFdlI")
if UserId_Info.id then
...
{{text = '- 𝖲??𝗎𝖱??𝖾 𝖾𝗂𝗅𝖺𝗇𝖣 .',url="t.me/lFdll"}},
}
}
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '𝙍ᥙ᥉᥉Ꭵᥲ 𝘵𝘦𝘢𝘮 † . ',url="https://t.me/lFdll"}},
}
}
...
local Text = "*- 𝘞𝘌𝘓𝘤𝘰𝘮𝘦 𝘵𝘰 𝙍ᥙ᥉᥉Ꭵᥲ 𝘵𝘦𝘢𝘮  .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '-  𝙍ᥙ᥉᥉Ꭵᥲ 𝘵𝘦𝘢𝘮 .',url="https://t.me/lFdll"}},
{{text = '- 𝘪𝘯𝘧𝘰 𝙍ᥙ᥉᥉Ꭵᥲ .',url="https://t.me/lFdlll"}},
{{text = '- 𝘋𝘌𝘷𝘦𝘭𝘰𝘱𝘦𝘳 .',url="https://t.me/lFdlI"}},
{{text = '- طلب نسخه .',url="https://t.me/e_h_t"}},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/lFdll&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
